    ...
    gsap.fromTo(
      ...
      { y: '20px' },
      {
        ...
        boxShadow: [
          ...
          'rgb(255, 0, 0) 10px -10px',
          'rgb(255, 255, 255) 20px -20px 0px -3px',
          'rgb(255, 213, 0) 20px -20px',
      ...
      return (
        ...
        >
          <div className="container-presentation">
            <h1 className="presentation" onClick={() => navigate('/about')}>
              {welcomePhrase}
            </h1>

            <h1 className="firstname" onClick={() => navigate('/skills')}>
              {firstName}
            </h1>

            <h1 className="secondname" onClick={() => navigate('/projects')}>
              {secondName}
            </h1>
          </div>
        </div>
